...
<div class="column fivecol">
	...
	<div class="profile-options clearfix">
		<?php if(!empty(ThemexUser::$data['active']['settings']['notices'])) { ?>
			...
			<a href="#contact_form" class="element-button element-colorbox"><?php _e('Kontak', 'makery'); ?></a>
				...
				<div id="contact_form">
					<div class="site-popup medium">
						<form class="site-form element-form" method="POST" action="<?php echo AJAX_URL; ?>">
							...
							<div class="field-wrap">
								<textarea name="message" cols="30" rows="5" placeholder="<?php _e('Pesan', 'makery'); ?>"></textarea>
							</div>
							<a href="#" class="element-button element-submit primary"><?php _e('Kirim Pesan', 'makery'); ?></a>
			...
			<!-- /popups -->
			<?php } else { ?>			
			<a href="<?php echo ThemexCore::getURL('register'); ?>" class="element-button"><?php _e('Kontak', 'makery'); ?></a>
			<?php } ?>
		<?php } ?>
