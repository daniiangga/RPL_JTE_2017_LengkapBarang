...
<div class="column fivecol">
	<div class="element-title indented">
		<h1><?php _e('Pembayaran saya', 'makery'); ?></h1>
	</div>
	...
	<span class="secondary"><?php _e('Jalaman ini tidak ada.', 'makery'); ?></span>
	<?php 
	} else {
			...
			<tr>
				...
				<td class="textright">
					<form action="" method="POST">
						<a href="#" title="<?php _e('Hapus', 'makery'); ?>" class="element-button element-submit small square secondary">
