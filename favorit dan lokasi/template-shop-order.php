...
<div class="column fivecol">
	<div class="element-title indented">
		<h1><?php _e('Ubah Pesanan', 'makery'); ?></h1>
	</div>
	...
	<span class="secondary"><?php _e('Pesanan ini tidak ada', 'makery'); ?></span>
	<?php } else { ?>
	<form action="" method="POST" class="site-form">
		...
		<table class="profile-table shop_table order_details">
			<thead>
				<tr>
					...
					<th class="product-total"><?php _e('Jumlah', 'makery'); ?></th>
				</tr>
			</thead>
			<tbody>
			...
			<tbody>
				<tr>
					...
					<td>
						...
						<strong><?php _e('No.HP:', 'makery'); ?></strong>&nbsp;<?php echo $order['phone']; ?>
						<?php } ?>
					</td>
				</tr>
				<tr>
					...
					<?php } else { ?>
					<th><?php _e('Alamat Billing', 'makery'); ?></th>
					<?php } ?>					
					<td>
				...
				<tr>
					<th><?php _e('Catatan Customer', 'makery'); ?></th>
					<td>
				...
				<tr>
					<th><?php _e('Catatan Pesanan', 'makery'); ?></th>
					<td>
		...
		<div class="field-wrap">
			<textarea name="order_note" id="order_note" cols="30" rows="5" placeholder="<?php _e('Catatan Pesanan', 'makery'); ?>"></textarea>
		</div>
		<?php } ?>
		<a href="#" class="element-button element-submit primary"><?php _e('Selesaikan Pesanan', 'makery'); ?></a>
