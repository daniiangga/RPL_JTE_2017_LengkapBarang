...
<div class="column fivecol">
	<div class="element-title indented">
		<h1><?php _e('Zona belanja', 'makery'); ?></h1>
	</div>
		...
		<tbody>
			...
			<tr>
				...
				<td class="textright nobreak">
					<a href="<?php echo ThemexCore::getURL('shop-zone', $zone['id']); ?>" title="<?php _e('Ubah', 'makery'); ?>" class="element-button small square secondary">
	...
	<a href="<?php echo ThemexCore::getURL('shop-zone'); ?>" class="element-button primary"><?php _e('Tambahkan zona', 'makery'); ?></a>
	<?php } ?>
</div>
